          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <NavLink
                  to="/"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-stroke dark:hover:bg-meta-4 ${(pathname === '/' ||
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-stroke dark:hover:bg-meta-4 ${pathname.includes('profile') && 'bg-stroke dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/users"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-stroke dark:hover:bg-meta-4 ${(
              ...
              <li>
                <NavLink
                  to="/categories"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-stroke dark:hover:bg-meta-4 ${pathname.includes('categories') &&
                    'bg-stroke dark:bg-meta-4'
                    }`}
                >
              ...
              <li>
                <NavLink
                  to="/orders"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-stroke dark:hover:bg-meta-4 ${pathname.includes('orders') &&
                    'bg-stroke dark:bg-meta-4'
                    }`}
                >
              ...
              <li>
                <NavLink
                  to="/sale"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-stroke dark:hover:bg-meta-4 ${pathname.includes('sale') &&
                    'bg-stroke dark:bg-meta-4'
                    }`}
                >

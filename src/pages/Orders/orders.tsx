...
const Orders = () => {
    ...
    const onPageChange = (page: number) => {
        get(`http://localhost:3000/api/order?limit=${selectedOption}&page=${page}`);
        setCurrentPage(page);
    ...
    useEffect(() => {
        get('http://localhost:3000/api/order?limit=2000&page=1');
    ...
    // useEffect(() => {
    //     get(`http://localhost:3000/api/order?limit=${selectedOption}`);
    //     console.log(response);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            await get(`http://localhost:3000/api/order?limit=${selectedOption}&page=${currentPage}`);
            console.log(response);
        };
                                        ...
                                        <tr key={key} className='border-b border-[#eee] dark:border-strokedark'>
                                            <td className="">
                                                <Link to={`/products/edit/${item.product.id}`} className="flex items-center py-5 px-4 pl-7 ">
                                                    <div className="flex-shrink-0 w-[58px] h-[58px] mr-3">
                                            ...
                                            <td className="py-5 px-4">
                                                ...
                                                {/* <select
                                                    ...
                                                    className={`bg-warning text-warning relative w-[115px] z-20 appearance-none rounded border border-stroke bg-transparent py-2 px-4 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${isOptionSelected ? 'text-black dark:text-white' : ''
                                                        }`}
                                                >
                                                    ...
                                                    <option value="delivered" className="text-body dark:text-bodydark">
                                                        delivered
                                                    </option>
                                                    <option value="canceled" className="text-body dark:text-bodydark">
                                                        canceled
                                                    </option>
                                                </select> */}
                                            </td>

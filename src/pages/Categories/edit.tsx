...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        if (responseSingleUser) {
            setState({
                name: responseSingleUser[0].name || "",
                description: responseSingleUser[0].description || "",
                status: responseSingleUser[0].status || "active",
                image: responseSingleUser[0].image || "",
            });
                                ...
                                <div className="p-6.5">
                                    <div className="relative z-30 mx-auto mb-4.5  h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
                                        <div className="relative drop-shadow-2 w-[152px] h-[152px]">
                                            <img src={selectedAvatar && URL.createObjectURL(selectedAvatar) || state.image} alt="profile" className="w-full h-full rounded-full object-cover" />
                                            <label
                                                htmlFor="profile"
